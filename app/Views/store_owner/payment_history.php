    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="#">Payment History</a></li>
            </ul>
...
<div class="sidebar-wrapper" id="sidebarWrapper">
    <div class="sidebar-card">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active" onclick="location.href='/store/payment-history'" data-tooltip="Payment History">
