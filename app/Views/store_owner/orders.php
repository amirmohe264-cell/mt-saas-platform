...
<section class="page-header">
    <div class="container-fluid px-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div>
                <h2><i class="fas fa-shopping-bag me-2 text-success"></i>Orders</h2>
                ...
                <div class="order-card">
                    <div class="row align-items-center">
                        <div class="col-md-3">
                            ...
                            <br>
                            <small class="text-muted"><i class="far fa-calendar-alt me-1"></i><?= date('M d, Y H:i', strtotime($order['created_at'])) ?></small>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <small class="text-muted"><i class="fas fa-user me-1"></i>Customer ID: <?= $order['customer_id'] ?></small>
                        </div>
