...
<head>
    ...
    <title>Edit Subcategory - ShopEase</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="#">Edit Subcategory</a></li>
            </ul>
...
<section class="page-header">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2><i class="fas fa-edit me-2"></i>Edit Subcategory</h2>
                <nav class="breadcrumb">
                    <a href="/store/dashboard">Dashboard</a>
                    <span class="mx-2 text-white-50">/</span>
                    <a href="/store/subcategories">Subcategories</a>
                    <span class="mx-2 text-white-50">/</span>
                    <span class="active">Edit Subcategory</span>
                </nav>
            </div>
        </div>
    </div>
...
<section class="py-4">
    <div class="container">
        ...
        <div class="form-card">
            <form action="/store/subcategories/update/<?= $subcategory['id'] ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="is_active" id="isActive" <?= $subcategory['is_active'] ? 'checked' : '' ?>>
                        <label class="form-check-label" for="isActive">Active</label>
                    </div>
                </div>
                
                <div class="d-flex gap-3">
                    <button type="submit" class="btn-save"><i class="fas fa-save me-2"></i>Update Subcategory</button>
