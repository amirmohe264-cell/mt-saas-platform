<!-- app/Views/store_owner/payouts.php -->
<?php
...
?>
<?php $active_menu = 'payouts'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Payouts - ShopEase</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="#">Payouts</a></li>
            </ul>
...
<div class="sidebar-wrapper" id="sidebarWrapper">
    <div class="sidebar-card">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active" onclick="location.href='/store/payouts'" data-tooltip="Payouts">
...
<section class="page-header">
    <div class="container-fluid px-4">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2><i class="fas fa-money-bill-wave me-2 text-success"></i>Payouts</h2>
                <nav class="breadcrumb">
                    <a href="/">Home</a>
                    <span class="mx-2">/</span>
                    <a href="/store/dashboard">Dashboard</a>
                    <span class="mx-2">/</span>
                    <span class="active">Payouts</span>
                </nav>
            </div>
        </div>
    </div>
...
<section class="main-content">
    <div class="container-fluid px-4">
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-3">
                <div class="stat-card">
                    <div class="number text-warning"><?= $summary['pending'] ?? 0 ?></div>
                    <div class="label">Pending</div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stat-card">
                    <div class="number text-info"><?= $summary['processing'] ?? 0 ?></div>
                    <div class="label">Processing</div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stat-card">
                    <div class="number text-success"><?= $summary['paid'] ?? 0 ?></div>
                    <div class="label">Paid</div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stat-card">
                    <div class="number text-danger"><?= $summary['failed'] ?? 0 ?></div>
        ...
        <div class="table-card">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="fw-bold mb-0"><i class="fas fa-list me-2 text-success"></i>Payout History</h5>
                <span class="text-muted">Total Pending: $<?= number_format($summary['total_pending_amount'] ?? 0, 2) ?></span>
            </div>
