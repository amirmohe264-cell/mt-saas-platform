...
<div class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-0"><i class="fas fa-user-edit me-2 text-success"></i>Edit Delivery Agent</h4>
            <small class="text-muted">Update agent information</small>
        </div>
    ...
    <div class="form-card">
        <form action="/delivery/agents/update/<?= $agent['id'] ?>" method="POST">
            <?= csrf_field() ?>
