<!-- app/Views/delivery_company/agents_edit.php -->
<?php
...
<head>
    ...
    <title>Edit Agent - ShopEase</title>
...
<section class="page-header">
    <div class="container-fluid px-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div>
                <h2><i class="fas fa-user-edit me-2 text-success"></i>Edit Delivery Agent</h2>
                <nav class="breadcrumb">
                    ...
                    <span class="mx-2">/</span>
                    <span class="active">Edit Agent</span>
                </nav>
            </div>
            <div>
...
<div class="main-content">
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
            <div>
                <h5 class="fw-bold mb-0"><i class="fas fa-user-edit me-2 text-success"></i>Edit Agent</h5>
                <small class="text-muted">Update information for <?= esc($agent['name'] ?? 'Agent') ?></small>
            </div>
        ...
        <div class="form-card">
            <form action="/delivery/agents/update/<?= $agent['id'] ?>" method="POST" id="agentForm">
                <?= csrf_field() ?>
                
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-semibold">Full Name <span class="text-danger">*</span></label>
                        <input type="text" name="name" class="form-control" placeholder="Enter full name" required value="<?= esc($agent['name']) ?>">
                        <small class="text-muted">Enter the agent's full legal name.</small>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-semibold">Email <span class="text-danger">*</span></label>
                        <input type="email" name="email" class="form-control" placeholder="agent@email.com" required value="<?= esc($agent['email']) ?>">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="phone" class="form-control" placeholder="Enter phone number" required value="<?= esc($agent['phone']) ?>">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="status" class="form-select">
                            ...
                            <option value="inactive" <?= ($agent['status'] ?? 'active') === 'inactive' ? 'selected' : '' ?>>Inactive</option>
                        </select>
                        <small class="text-muted">Inactive agents cannot be assigned deliveries.</small>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" name="password" class="form-control" placeholder="Enter new password to change" id="passwordInput">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-muted small">
                                <i class="fas fa-calendar me-1"></i>Joined: <?= date('M d, Y H:i', strtotime($agent['created_at'])) ?>
                                <?php if (isset($agent['updated_at']) && $agent['updated_at'] != $agent['created_at']): ?>
                                    <span class="ms-3"><i class="fas fa-edit me-1"></i>Last updated: <?= date('M d, Y H:i', strtotime($agent['updated_at'])) ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    console.log('ShopEase Delivery - Edit Agent Page Loaded');
