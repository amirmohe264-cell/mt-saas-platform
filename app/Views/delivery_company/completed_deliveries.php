...
<div class="sidebar">
    ...
    <a href="/delivery/completed" class="menu-item active">
...
<div class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-0"><i class="fas fa-check-circle me-2 text-success"></i>Completed Deliveries</h4>
            <small class="text-muted">Successfully delivered orders</small>
        </div>
        <span class="badge bg-success"><?= count($assignments ?? []) ?> Completed</span>
    </div>
