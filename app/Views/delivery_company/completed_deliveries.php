<!-- app/Views/delivery_company/completed_deliveries.php -->
<?php
...
<head>
    ...
    <title>Completed Deliveries - ShopEase</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .completed-item .order-number {
            font-weight: 600;
            color: #1a2e1a;
            font-size: 1.05rem;
        }
        .completed-item .order-date {
            color: #888;
            font-size: 0.85rem;
        }
        .completed-item .delivery-time {
            color: #4caf50;
            font-weight: 500;
        }
        ...
        @media (max-width: 992px) {
            ...
            .completed-item { padding: 12px 15px; }
        }

        @media (max-width: 576px) {
            .page-header h2 { font-size: 1.3rem; }
            .completed-item .order-number { font-size: 0.95rem; }
            .completed-item .order-date { font-size: 0.75rem; }
...
<div class="sidebar-wrapper" id="sidebarWrapper">
    ...
    <i class="fas fa-bars"></i>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active" onclick="location.href='/delivery/completed'" data-tooltip="Completed Deliveries">
...
<section class="page-header">
    <div class="container-fluid px-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div>
                <h2><i class="fas fa-check-circle me-2 text-success"></i>Completed Deliveries</h2>
                <nav class="breadcrumb">
                    <a href="/">Home</a>
                    <span class="mx-2">/</span>
                    <a href="/delivery/dashboard">Dashboard</a>
                    <span class="mx-2">/</span>
                    <span class="active">Completed Deliveries</span>
                </nav>
            </div>
            <div>
...
<div class="main-content">
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
            <div>
                <h5 class="fw-bold mb-0"><i class="fas fa-check-circle me-2 text-success"></i>Successfully Delivered</h5>
                <small class="text-muted">Orders that have been completed successfully</small>
            </div>
            <div>
                <span class="badge bg-success rounded-pill fs-6 px-3 py-2">
                    <i class="fas fa-check-circle me-1"></i> <?= count($assignments ?? []) ?> Completed
                </span>
            </div>
        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                        <div>
                            ...
                            <div class="order-date mt-1">
                                ...
                                <?= date('M d, Y H:i', strtotime($assignment['updated_at'] ?? $assignment['created_at'])) ?>
                                ...
                                <?php endif; ?>
                                <?php if (isset($assignment['delivered_at'])): ?>
                                    <span class="ms-3 delivery-time">
                                        <i class="fas fa-clock me-1"></i>
                                        Delivered: <?= date('M d, Y H:i', strtotime($assignment['delivered_at'])) ?>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
        ...
        <?php else: ?>
            <div class="text-center py-5">
                <div class="empty-state">
                    <i class="fas fa-box-open fa-4x d-block mb-3 text-muted"></i>
                    <h5 class="text-muted">No Completed Deliveries</h5>
                    <p class="text-muted">Completed deliveries will appear here once orders are successfully delivered.</p>
                    <a href="/delivery/active" class="btn btn-outline-success mt-2" style="border-radius: 30px; padding: 10px 30px;">
                        <i class="fas fa-spinner me-2"></i>View Active Deliveries
                    </a>
                </div>
            </div>
        <?php endif; ?>
...
<script>
    ...
    console.log('ShopEase Delivery - Completed Deliveries Page Loaded');
