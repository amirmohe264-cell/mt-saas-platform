...
<div class="sidebar">
    ...
    <a href="/delivery/orders" class="menu-item active">
...
<div class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-0"><i class="fas fa-list me-2 text-success"></i>Delivery Orders</h4>
            <small class="text-muted">Manage all delivery assignments</small>
        </div>
    </div>
    ...
    <div class="mb-3">
        ...
        $currentStatus = $current_status ?? 'all';
        foreach ($statuses as $status):
            $label = $status === 'all' ? 'All' : ucfirst(str_replace('_', ' ', $status));
        ?>
        ...
        <?php foreach ($assignments as $assignment): ?>
            <div class="order-item">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <span class="fw-bold me-3">$<?= number_format($assignment['order_total'] ?? 0, 2) ?></span>
