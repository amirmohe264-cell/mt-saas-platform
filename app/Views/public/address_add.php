<!-- app/Views/public/address_add.php -->
<?php
...
<head>
    ...
    <title>Add Address - ShopEase</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="#">Add Address</a></li>
            </ul>
...
<section class="py-4">
    <div class="container">
        <div class="form-card">
            <h4><i class="fas fa-plus-circle me-2 text-success"></i>Add New Address</h4>
            <hr>
            ...
            <form action="/addresses/store" method="post">
                <?= csrf_field() ?>
                
                <div class="mb-3">
                    <label>Address Name <small class="text-muted">(e.g., Home, Work, Office)</small></label>
                    <input type="text" name="address_name" class="form-control" placeholder="Enter address name" value="<?= old('address_name') ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="address_line1" class="form-control" placeholder="Street address, P.O. box" value="<?= old('address_line1') ?>" required>
                </div>

                <div class="mb-3">
                    <label>Address Line 2 <small class="text-muted">(Optional)</small></label>
                    <input type="text" name="address_line2" class="form-control" placeholder="Apartment, suite, unit, building, floor" value="<?= old('address_line2') ?>">
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="state" class="form-control" placeholder="Enter state/region" value="<?= old('state') ?>">
                    </div>
                </div>
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" class="form-check-input" name="is_default" id="isDefault" value="1" <?= old('is_default') ? 'checked' : '' ?>>
                    <label class="form-check-label" for="isDefault">Set as default address</label>
                </div>

                <div class="d-flex gap-3">
                    <button type="submit" class="btn-save"><i class="fas fa-save me-2"></i>Save Address</button>
