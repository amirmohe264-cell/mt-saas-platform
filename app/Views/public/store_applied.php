<!-- app/Views/public/store_apply_success.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ─── SUCCESS CARD ───────────────────────────── */
        .success-card {
            background: var(--white); border-radius: var(--radius-lg); padding: 50px;
            border: 1px solid var(--border); box-shadow: var(--shadow);
            max-width: 600px; margin: 0 auto; text-align: center;
        }
        .success-card .icon { font-size: 5rem; color: #10b981; margin-bottom: 20px; }
        .success-card h3 { font-family: var(--display); color: var(--brand); font-weight: 800; }
        ...
        .btn-home:hover { background: #c73652; color: #fff; transform: translateY(-2px); }
