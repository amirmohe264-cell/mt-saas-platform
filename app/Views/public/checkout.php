                    ...
                    <div class="checkout-card">
                                ...
                                <?php foreach ($cartItems as $item): ?>
                                    <div class="order-item">
                                        ...
                                        <div class="item-price">
                                            <?= number_format(($item['price'] ?? 0) * ($item['quantity'] ?? 1), 2) ?> ETB
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            <?php else: ?>
                        ...
                        <div class="price-breakdown">
                            <div class="price-row">
                                ...
                                <span><?= number_format($subtotal ?? 0, 2) ?> ETB</span>
                            </div>
                            <div class="price-row">
                                <span class="label">Shipping</span>
                                <span><?= number_format($shipping ?? 5.00, 2) ?> ETB</span>
                            </div>
                            <div class="price-row">
                                <span class="label">Tax (8%)</span>
                                <span><?= number_format($tax ?? 0, 2) ?> ETB</span>
                            </div>
                            <div class="price-row total">
                                <span class="label">Total</span>
                                <span><?= number_format($total ?? 0, 2) ?> ETB</span>
                            </div>
                        </div>
