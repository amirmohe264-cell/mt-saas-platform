...
<head>
    ...
    <style>
        ...
        .help-card { background: #fff; border-radius: 12px; padding: 25px; border: 1px solid #e8f0e8; transition: 0.3s; height: 100%; }
        .help-card:hover { transform: translateY(-3px); box-shadow: 0 5px 20px rgba(0,0,0,0.05); }
        .help-card i { font-size: 2rem; color: #4caf50; margin-bottom: 15px; }
        .help-card h5 { color: #1a2e1a; font-weight: 600; }
        .help-card p { color: #888; }
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="help-card">
                    ...
                    <a href="/returns" class="text-success">Learn More →</a>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="help-card">
                    ...
                    <a href="/shipping" class="text-success">Learn More →</a>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="help-card">
            ...
            <div class="col-md-4 mb-4">
                <div class="help-card">
                    ...
                    <a href="/login" class="text-success">Learn More →</a>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="help-card">
                    ...
                    <a href="/contact" class="text-success">Learn More →</a>
                </div>
            </div>
        </div>
    </div>
