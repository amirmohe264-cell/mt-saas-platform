...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-approve:hover { background: #1e7e34; color: #fff; transform: translateY(-2px); box-shadow: 0 4px 15px rgba(40,167,69,0.3); }
        ...
        .btn-reject:hover { background: #bd2130; color: #fff; transform: translateY(-2px); box-shadow: 0 4px 15px rgba(220,53,69,0.3); }
        ...
        .btn-back:hover { background: #5a6268; color: #fff; transform: translateY(-2px); }
        ...
        @media (max-width: 576px) {
            ...
            .detail-card .label { font-size: 0.75rem; }
        }
    </style>
</head>
<body id="mainBody">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="/admin/store-requests">Store Requests</a></li>
...
<div class="sidebar-wrapper" id="sidebarWrapper">
    <div class="sidebar-card">
        <button class="toggle-sidebar-btn" onclick="toggleSidebar()">
            ...
            <span id="toggleLabel">Collapse</span>
        </button>
...
<script>
    ...
    console.log('ShopEase Admin - Request Details Page Loaded');
