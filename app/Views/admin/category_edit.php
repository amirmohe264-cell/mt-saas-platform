    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="#">Edit Category</a></li>
            </ul>
        ...
        <div class="form-card">
            <form action="/admin/categories/update/<?= $category['id'] ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="category_description" class="form-control" rows="3"><?= old('category_description', $category['category_description']) ?></textarea>
                </div>
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="is_active" id="isActive" <?= $category['is_active'] ? 'checked' : '' ?>>
                        <label class="form-check-label" for="isActive">Active</label>
                    </div>
                </div>
                
                <div class="d-flex gap-3">
                    <button type="submit" class="btn-save"><i class="fas fa-save me-2"></i>Update Category</button>
