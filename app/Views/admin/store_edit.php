...
<head>
    ...
    <title>Edit Store - ShopEase</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="#">Edit Store</a></li>
            </ul>
...
<section class="page-header">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2><i class="fas fa-edit me-2"></i>Edit Store</h2>
                <nav class="breadcrumb">
                    <a href="/admin/dashboard">Dashboard</a>
                    <span class="mx-2 text-white-50">/</span>
                    <a href="/admin/stores">Stores</a>
                    <span class="mx-2 text-white-50">/</span>
                    <span class="active">Edit Store</span>
                </nav>
            </div>
        </div>
    </div>
...
<section class="py-4">
    <div class="container">
        ...
        <div class="form-card">
            <form action="/admin/store/update/<?= $tenant['id'] ?>" method="post">
                <?= csrf_field() ?>
                
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label>Store Name <span class="required">*</span></label>
                        <input type="text" name="store_name" class="form-control" value="<?= old('store_name', $tenant['store_name']) ?>" required>
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="owner_name" class="form-control" value="<?= old('owner_name', $owner['full_name'] ?? '') ?>" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label>Contact Email <span class="required">*</span></label>
                        <input type="email" name="contact_email" class="form-control" value="<?= old('contact_email', $tenant['contact_email']) ?>" required>
                    </div>
                </div>

                <div class="mb-3">
                    <label>Contact Phone <span class="required">*</span></label>
                    <input type="tel" name="contact_phone" class="form-control" value="<?= old('contact_phone', $tenant['contact_phone']) ?>" required>
                </div>

                <div class="mb-3">
                    <label>Store Description</label>
                    <textarea name="store_description" class="form-control" rows="2"><?= old('store_description', $tenant['store_description']) ?></textarea>
                </div>

                <div class="mb-3">
                    <label>Store Address <span class="required">*</span></label>
                    <textarea name="store_address" class="form-control" rows="2" required><?= old('store_address', $tenant['store_address']) ?></textarea>
                </div>

                <div class="d-flex gap-3">
                    <button type="submit" class="btn-save"><i class="fas fa-save me-2"></i>Update Store</button>
