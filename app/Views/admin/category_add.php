    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="#">Add Category</a></li>
            </ul>
...
<section class="page-header">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2><i class="fas fa-plus-circle me-2"></i>Add Category</h2>
        ...
        <div class="form-card">
            <form action="/admin/categories/store" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="category_name" class="form-control" placeholder="e.g. Electronics" value="<?= old('category_name') ?>" required>
                </div>
                
                <div class="mb-3">
                    <label>Category Description</label>
                    <textarea name="category_description" class="form-control" rows="3" placeholder="Describe this category..."><?= old('category_description') ?></textarea>
                </div>
                ...
                <div class="d-flex gap-3">
                    <button type="submit" class="btn-save"><i class="fas fa-save me-2"></i>Save Category</button>
                    <a href="/admin/categories" class="btn-cancel"><i class="fas fa-times me-2"></i>Cancel</a>
                </div>
            </form>
        </div>
    </div>
