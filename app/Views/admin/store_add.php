...
<head>
    ...
    <title>Add Store - ShopEase</title>
    ...
    <style>
        ...
        .btn-generate { background: #17a2b8; color: #fff; border: none; border-radius: 30px; padding: 10px 20px; font-weight: 600; transition: 0.3s; }
        .btn-generate:hover { background: #117a8b; color: #fff; }
        ...
        .password-field { background: #f8f9fa; border-radius: 8px; padding: 10px; }
        .password-field .form-control { border: 2px solid #e8f0e8; }
        .password-field .btn { border-radius: 30px; }
    </style>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="#">Add Store</a></li>
            </ul>
...
<section class="page-header">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2><i class="fas fa-plus-circle me-2"></i>Add Store</h2>
                <nav class="breadcrumb">
                    <a href="/admin/dashboard">Dashboard</a>
                    <span class="mx-2 text-white-50">/</span>
                    <a href="/admin/stores">Stores</a>
                    <span class="mx-2 text-white-50">/</span>
                    <span class="active">Add Store</span>
                </nav>
            </div>
        </div>
    </div>
            ...
            <form action="/admin/store/store" method="post">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="owner_name" class="form-control" placeholder="John Doe" value="<?= old('owner_name') ?>" required>
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" name="contact_email" class="form-control" placeholder="store@example.com" value="<?= old('contact_email') ?>" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label>Contact Phone <span class="required">*</span></label>
                        <input type="tel" name="contact_phone" class="form-control" placeholder="+1 234 567 890" value="<?= old('contact_phone') ?>" required>
                    </div>
                </div>

                <div class="mb-3">
                    <label>Store Description</label>
                    <textarea name="store_description" class="form-control" rows="2" placeholder="Describe your store..."><?= old('store_description') ?></textarea>
                </div>
                ...
                <div class="mb-3 password-field">
                    <label>Create Password for Store Owner <span class="required">*</span></label>
                    <div class="row g-2">
                        <div class="col-md-8">
                            <input type="text" name="manual_password" id="manualPassword" class="form-control" placeholder="Enter a strong password" value="<?= old('manual_password') ?>" required>
                        </div>
                        <div class="col-md-4">
                            <button type="button" class="btn-generate w-100" onclick="generatePassword()">
                                <i class="fas fa-sync me-1"></i>Generate
                            </button>
                        </div>
                    </div>
                    <small class="text-muted">Minimum 8 characters. Use a combination of letters, numbers, and symbols.</small>
                </div>

                <div class="d-flex gap-3">
                    <button type="submit" class="btn-save"><i class="fas fa-save me-2"></i>Create Store</button>
                    <a href="/admin/stores" class="btn-cancel"><i class="fas fa-times me-2"></i>Cancel</a>
                </div>
            </form>
        </div>
    </div>
