...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .escrow-card .order-number { font-weight: 700; color: #1a2e1a; font-size: 1.1rem; }
...
<div class="sidebar-wrapper" id="sidebarWrapper">
    <div class="sidebar-card">
        ...
        <ul class="sidebar-menu">
            <li onclick="location.href='/admin/payments'" data-tooltip="Payments">
        ...
        <ul class="sidebar-menu">
            ...
            <li onclick="location.href='/admin/help'" data-tooltip="Help">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div>
                ...
                <nav class="breadcrumb">
                    ...
                    <span class="mx-2">/</span>
                    <span class="text-muted">Escrow Releases</span>
                </nav>
            </div>
            <div>
