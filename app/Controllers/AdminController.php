...
class AdminController extends BaseController
{
    ...
    public function updateDeliveryCompany($id)
    {
        ...
        $updated = $deliveryCompanyModel->update($id, $data);
        
        if ($updated) {
            return redirect()->to('/admin/delivery-companies')
                ->with('success', 'Company updated successfully!');
        }
        
        return redirect()->back()
            ->withInput()
            ->with('error', 'Failed to update company: ' . implode(', ', $deliveryCompanyModel->errors()));
    }
    ...
    // ==========================================
    // RESET DELIVERY COMPANY PASSWORD (FIXED)
    // ==========================================
